...
| ELIMINACIÓN DINÁMICA | - El archivo de registro de auditoría se elimina en función de la retención - por defecto, solo se conservan 10 archivos 


| ELIMINACIÓN INESPERADA | Se elimina el archivo de registro de auditoría 


| ACTIVO | - El archivo de registro de auditoría está en uso - solo aplicable a audit.log 
|===
