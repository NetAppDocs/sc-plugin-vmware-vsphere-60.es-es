...
.Antes de empezar
* La cuenta de usuario del sistema de almacenamiento, en la página Storage Systems del cliente de VMware vSphere, debe tener link:scpivs44_minimum_ontap_privileges_required.html["Privilegios mínimos requeridos de ONTAP para ONTAP"].
